...
export default function SearchBar({onSearch}) {;
   ...
   return (
      <div>
         <input className='bar' placeholder="1 to 826" type='search' onChange={handleChange} value={id}/> {/* Significa que cada vez que haya un cambio, se dispare la funcion onChange */}
         <button className='boton1' onClick={handleSubmit}><strong>Add</strong></button>
